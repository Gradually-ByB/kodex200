          ...
          <div className="flex justify-between items-center">
            <CardTitle className="text-sm font-medium text-slate-400 flex items-center gap-2">
              ...
              <span>
                내 보유 자산 현황
                {subtitle && (
                  <span className="text-blue-500/80 ml-1.5 font-bold tracking-tight">
                    ({subtitle})
                  </span>
                )}
              </span>
            ...
            <Badge
              variant="outline"
              className="border-slate-700 text-slate-400 font-normal"
            >
              보유 {quantity}주
            </Badge>
          </div>
          ...
          <div className="space-y-1">
            ...
            >
              {totalReturnRate >= 0 ? (
                ...
                <TrendingDown size={20} className="self-center" />
              )}
              <p className="text-2xl font-bold tracking-tight">
                <span className="inline-block scale-y-[1.5] origin-bottom">
                  {totalReturnRate >= 0 ? "+" : ""}
