...
import { History, TrendingUp, TrendingDown, Minus, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight } from 'lucide-react';
                                ...
                                <AnimatePresence mode="wait">
                                    {paginatedHistory.length === 0 ? (
                                        <TableRow className="border-slate-900">
                                            <TableCell colSpan={6} className="h-32 text-center text-slate-500 text-sm italic">
                                                기록된 히스토리가 없습니다.
                                            </TableCell>
                                        </TableRow>
                                    ) : (
                ...
                {totalPages > 1 && (
                    <CardFooter className="border-t border-slate-900 bg-slate-900/20 py-4 flex items-center justify-center gap-2">
                        ...
                        <div className="flex items-center gap-1 px-4 text-slate-400 text-xs font-bold">
                            Page <span className="text-blue-400 mx-1">{currentPage}</span> of {totalPages}
                        </div>
